...
- Cross-camera: FAIL (mean 13.22 mm, median 11.31 mm, max 35.58 mm)
...
| cam3 | fixed | T_base_C3 | cube_chain_ref | FAIL | -284.058 | 981.959 | 115.670 | -154.283 | -5.203 | -99.760 | 15.095 | 1.934 | 18 | 18 | fallback from cube anchor support=14/18 |
| cube | object | T_base_O | consistent_event_anchor | FAIL | -281.162 | 326.681 | 0.989 | -15.368 | -2.287 | 12.289 | 0.739 | 0.293 | 4 | 18 | static cube anchor in robot base |
...
| T_C0_C3 | FAIL | -512.622 | -111.635 | 670.407 | 176.273 | 73.235 | 163.120 | derived from T_base_C0 and T_base_C3 |
