...
- Cube reprojection: FAIL (mean 12.746 px, median 9.139 px, max 61.027 px)
...
| cam3 | fixed | T_base_C3 | cube_anchor | FAIL | 87.756 | 27.883 | 135.792 | 40.884 | 1.085 | -102.359 | 0.000 | 0.000 | 4 | 4 | fallback from cube anchor support=4/18 |
| cube | object | T_base_O | board_anchor | FAIL | -266.739 | 335.483 | 1.202 | 68.778 | 0.989 | -90.554 | 6.950 | 0.823 | 8 | 36 | static cube anchor in robot base |
...
| T_C0_C3 | FAIL | 441.054 | -59.745 | 300.649 | -73.367 | -83.843 | 62.715 | derived from T_base_C0 and T_base_C3 |
