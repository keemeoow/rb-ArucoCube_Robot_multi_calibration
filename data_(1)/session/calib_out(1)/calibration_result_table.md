...
| cam0 | fixed | T_base_C0 | board-based | PASS | -408.890 | 146.657 | 109.664 | -44.917 | 1.264 | -97.670 | 4.187 | 0.217 | 13 | 14 | fixed camera extrinsic from ChArUco board |
...
| cam3 | fixed | T_base_C3 | cube_anchor_primary+board_refined | PASS | -248.965 | 914.837 | 124.234 | -158.420 | -0.153 | -109.358 | 3.343 | 0.441 | 18 | 18 | fallback from cube anchor support=18/18 |
